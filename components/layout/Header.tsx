  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[100] border-b border-[#B3B3B366] bg-white shadow-sm">
      <div className="container flex h-[68px] items-center justify-between px-4 md:px-8">
        ...
        <Link
          href="/contact"
          className="hidden lg:inline-block rounded-md border-[2px] border-[#3F89FF] px-5 py-2 text-sm font-medium text-[var(--color-primary)] transition hover:bg-[#2563EB] hover:text-white font-semibold "
        >
          Contact Us
        </Link>
          ...
          <nav className="flex flex-col gap-1">
            {navLinks.map((item, i) => (
              <Link
                ...
                className={`w-fit py-2 text-lg font-medium font-mono text-[#000000CC] transition-all duration-300 ease-out  ${
                  mobileOpen
