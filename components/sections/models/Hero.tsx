...
export default function Hero() {
    ...
    return (
        <>
            <section className="mod_hr_x py-15 px-6 relative bx_ptrn overflow-hidden h-dvh flex items-center">
                ...
                <div className="container mx-auto ">
                    <div className="relative z-1 max-w-[800px]">
                        <AnimatedText as="p" className="text-blue text-start text-sm uppercase font-mono font-normal bg-chip inline-block px-4 rounded-2xl py-1 mb-7">Zipnach modelS</AnimatedText>
                        <Heading as="h1" className="mb-2 text-6xl leading-[110%] text-start font-medium font-primary text-heading"><span className="text-primary">Flexible</span> Deployment. <br />
