    ...
    <>
      ...
      <div className="pt-28 flex items-center justify-center">
        <div className="container">
          <div className="flex flex-col items-center justify-center text-center">
            <h5 className="max-w-[623px] w-full border border-[#CACAFF] flex items-center justify-center uppercase rounded-[35px] text-[10px] md:text-sm text-[#3535DD] font-mono bg-white lg:mb-[40px] md:mb-[22px] mb-[16px] p-1">
            ...
            <Heading
              ...
              as="h1"
            >
              Authenticate, Digitize and Automate your NACH Mandate.
            </Heading>
            <p className="max-w-[704px] text-[var(--color-gray)] mb-[16px] md:mb-[45px] lg:mb-[75px] text-xs md:text-[16px]">
      ...
      <section className="relative overflow-hidden pb-24 md:pb-32 px-2 flex flex-col items-center justify-center">
        ...
        <div className="container relative z-1">
          <div className="mx-auto max-w-[990px] rounded-[24px] bg-[#FFFFFF1A] p-3 shadow-[2px_2px_12px_0px_#0000001A] backdrop-blur-sm">
