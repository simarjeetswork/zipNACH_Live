            ...
            <div className="container">
                <div className="flex flex-col items-center justify-center text-center">
                    <h5 className="max-w-[623px] w-full border border-[#CACAFF] flex items-center justify-center uppercase rounded-[35px] text-[10px] md:text-sm text-[#3535DD] font-mono bg-white lg:mb-[40px] md:mb-[22px] mb-[16px] p-1">End-to-End Mandate Management → From authentication to reconciliation</h5>
                     <Heading className="max-w-[958px] mb-3 leading-[120%] text-[var(--text-heading-dark)] font-primary font-medium text-[26px] md:text-[46px] lg:text-[56px]" as="h1" >Authenticate, Digitize and Automate your NACH Mandate.</Heading>
                    <p className="max-w-[704px] text-[var(--color-gray)] mb-[16px] md:mb-[45px] lg:mb-[75px] text-xs md:text-[16px]">Digitize your entire recurring process. Enables corporates to use their interface or application with the benefits of zipNACH platform.</p>
                </div>
            </div>
        </div>
